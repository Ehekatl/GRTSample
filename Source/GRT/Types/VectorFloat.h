...
public:
  ...
  /**
     Copy Constructor, copies the values from the rhs VectorFloat to this
        VectorFloat instance
  ...
  /**
     Defines how the data from the rhs VectorFloat should be copied to this
        VectorFloat
  ...
  /**
     Defines how the data from the rhs Vector< Float > should be copied to this
        VectorFloat
  ...
  /**
     Scales the vector to a new range given by the min and max targets, this
        uses the minimum and maximum values in the
  ...
  /**
     Scales the vector to a new range given by the min and max targets using the
        ranges as the source ranges.

     @return returns true if the vector was scaled, false otherwise
   */
  bool scale(const float minSource,
